...
<div class="container-fluid py-4">
                ...
                <div class="card-body text-white py-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h2 class="fw-bold mb-1">Old Orders Archive</h2>
                                <p class="mb-0 opacity-75">Historical order records and transactions</p>
                            </div>
                        </div>
                        <div class="text-end">
                            <div class="bg-white text-black bg-opacity-20 rounded-lg p-3">
                                <h3 class="fw-bold mb-0" id="totalOrders">0</h3>
                                <small class="opacity-75">Archived Orders</small>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                ...
                                <select class="form-select shadow-sm" id="serviceType">
                                    ...
                                    <option value="Filing Multiple Form-16 Online">Filing Multiple Form-16 Online</option>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <nav aria-label="Old Orders pagination">
...
document.addEventListener("DOMContentLoaded", function() {
                ...
                <tr>
                    <td colspan="7" class="text-center py-5">
                        <div class="text-muted">
                            <i class="bi bi-archive display-1 d-block mb-3"></i>
                            <h5>No archived orders found</h5>
                        ...
                        <div class="card border-0 m-3">
                            <div class="card-body">
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <h6 class="text-primary mb-3"><i class="bi bi-receipt me-2"></i>Transaction Details</h6>
                                        <div class="row g-2">
                                            ...
                                            <div class="col-sm-5"><strong>Bank Transaction ID:</strong></div>
                                            <div class="col-sm-7"><code>${order.bankTransactionId ?? 'N/A'}</code></div>
                                            <div class="col-sm-5"><strong>Payment Order ID:</strong></div>
                                            <div class="col-sm-7"><code>${order.paymentOrderId ?? 'N/A'}</code></div>
                                            <div class="col-sm-5"><strong>Transaction ID:</strong></div>
                                            <div class="col-sm-7"><code>${order.transtionId ?? 'N/A'}</code></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    document.getElementById("downloadCsvBtn").addEventListener("click", () => {
        ...
        setTimeout(() => {
            const csvRows = [];
            const headers = ["#", "Name", "Email", "Amount", "Gateway", "Status", "Service", "Domain", "Mobile", "Bank Transaction ID"];
            ...
            link.setAttribute("download", `old_orders_${new Date().toISOString().split('T')[0]}.csv`);
    ...
    document.getElementById("downloadPdfBtn").addEventListener("click", function() {
        ...
        setTimeout(() => {
            ...
            doc.text('Old Orders Archive Report', 20, 20);
            ...
            doc.save(`old_orders_${new Date().toISOString().split('T')[0]}.pdf`);
            hideLoading();
        }, 500);
    });
